...
class LocalGtpBot:
    def __init__(self, go_bot, termination=None, handicap=0, opponent='gnugo', ooutpu_sgf='out.sgf', our_color='b'):
        self.bot = TerminationAgent(go_bot, termination)
        self.handicap = handicap
        self._stopped = False
        self.game_state = GameState.new_game(19)
        self.sgf = SGFWriter(ooutpu_sgf)
    ...
    def set_handicap(self):
        if self.handicap == 0:
            ...
            for pos in stones.split(" "):
                ...
                sgf_handicap = sgf_handicap + "[" + self.sgf.coordinate(move) + "]"
