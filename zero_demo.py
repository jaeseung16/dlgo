...
pb = board_input
for i in range(4):
    pb = Conv2D(64, (3, 3), padding='same', data_format='channels_last', activation='relu')(pb)

policy_conv = Conv2D(2, (1, 1), data_format='channels_last', activation='relu')(pb)
policy_flat = Flatten()(policy_conv)
policy_output = Dense(encoder.num_moves(), activation='softmax')(policy_flat)

value_conv = Conv2D(1, (1, 1), data_format='channels_last', activation='relu')(pb)
